...
both data and functions within them.
...
objects. But Objects can have different values of those properties. For example
we can consider Human as class and its object would be a particular man say jon doe 
with defined properties and behaviors such as the name, age, no. of legs, walking .. 

In a class, variables are called properties and functions are called methods or 
even behaivor ! 
...
class Human {
   ...
   function set_character($char) {
    ...
    of the object.
    Note that its common to use same argument name as of property but for me 
    it was bit confusion. 
    ...
    */
    // Q. EXPLAIN WHAT IS 'this' keyword in OOPs? *** 
   }  
/*
